...
class KVBlockStore:
    # Minimal KV block store for real tensor movement experiments. Not
    # integrated with model execution: it only proves that KV-like tensors
    # can be moved between GPU and CPU with resident memory and transfer
