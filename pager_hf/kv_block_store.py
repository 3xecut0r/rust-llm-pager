...
class KVBlockStore:
    """
    Physically moves KV-cache blocks between GPU and CPU memory.

    This is the runtime-agnostic primitive behind pager_hf: it does not know
    about HuggingFace, only about (key, value) tensor pairs indexed by block id.
    """
    ...
    def apply_tiers(
        ...
        """
        Apply pager tier placement to real KV tensors.
